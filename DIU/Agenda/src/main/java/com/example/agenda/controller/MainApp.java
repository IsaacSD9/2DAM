...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        personData.add(new Person("Isaac", "Romero"));
        personData.add(new Person("Chidera", "Ejuke"));
        personData.add(new Person("Jesús", "Navas"));
        personData.add(new Person("Lucien", "Agoumé"));
        personData.add(new Person("Loic", "Badé"));
        personData.add(new Person("Lamine", "Llamal"));
        personData.add(new Person("Francisco", "Mejías"));
        personData.add(new Person("Manuel", "Romero"));
        personData.add(new Person("Pablo", "Rodríguez"));
    }
