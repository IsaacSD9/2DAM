...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            btTexto.setText("Pulsa Aquí");

            Image imagen = new Image("file:resources/images/fanta.jpg", 100, 100, true, true);
            ...
            Image imagen2 = new Image("file:resources/images/ilia.png", 100, 100, true, true);
